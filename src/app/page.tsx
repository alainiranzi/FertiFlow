  ...
  return (
    <div className="h-screen flex items-center justify-center bg-gray-100 p-6 overflow-hidden relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute right-[-641px] top-[-433px] w-[1600px] h-[1600px] bg-emerald-200 rotate-45 opacity-60"></div>
        <div className="absolute right-[-740px] top-[-297px] w-[1600px] h-[1600px] bg-emerald-300 rotate-45 opacity-30"></div>
      </div>
