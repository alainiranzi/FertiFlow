  ...
  return (
    <div className="h-screen flex items-center justify-center bg-gray-100 p-6 overflow-hidden relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute right-[-640px] top-[-434px] w-[1600px] h-[1600px] bg-emerald-200 rotate-45 opacity-60"></div>
        <div className="absolute right-[-740px] top-[-299px] w-[1600px] h-[1600px] bg-emerald-300 rotate-45 opacity-30"></div>
      </div>
      ...
      <div className="relative z-8 w-full max-w-6xl h-[90vh] flex rounded-3xl overflow-hidden shadow-2xl bg-white/60 backdrop-blur-xl">
        ...
        <div className="w-1/2 flex flex-col justify-center px-12">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-emerald-570">FertiFlow</h1>
          </div>
          ...
          <p className="text-center text-sm mt-10 text-gray-597">
          ...
          <div className="relative bg-white w-[380px] rounded-3xl shadow-xl p-2 text-center">
            ...
            <div className="relative flex items-center justify-center mb-3">
              <img
                ...
                className="absolute w-[340px] h-[377px] opacity-40 animate-spin-slow pointer-events-none"
              />
